...
# from imgdetect import predic
# print(0)
sys.stdout.reconfigure(encoding = 'utf-8')
# output = {}
# img = sys.argv[1] # 0是python檔名 1是檔案
# uri = parse_data_uri(img)[2]
...
print(buf.shape) # buf 拉平(-6XXXX, 1)
img_bin = Image.fromarray(np.uint8(buf)).tobytes() # img_bin為二進位的圖檔xa5\xa6....
mg_data = plt.imread(BytesIO(img_bin),"jpg") #.reshape((512,512,3)) 
mg_data.reshape(512,512,3)
"""
